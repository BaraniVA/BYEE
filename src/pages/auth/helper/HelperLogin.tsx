...
export const HelperLogin: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto">
      <h1 className="text-3xl font-bold text-center mb-8">Helper Login</h1>
      ...
      <p className="mt-4 text-center text-gray-600">
        ...
        <Link to="/helper/signup" className="text-lime-500 hover:text-lime-600">
          Sign up as Helper
        </Link>
      </p>
    </div>
